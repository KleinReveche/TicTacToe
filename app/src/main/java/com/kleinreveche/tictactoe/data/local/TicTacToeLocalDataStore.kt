...
class TicTacToeLocalDataStore(private val dataStore: DataStore<Preferences>) {
    ...
    companion object {
        ...
        private val WINS_HARD_KEY = intPreferencesKey("wins_hard")
        private val LOSES_HARD_KEY = intPreferencesKey("loses_hard")
        private val DRAWS_HARD_KEY = intPreferencesKey("draws_hard")
